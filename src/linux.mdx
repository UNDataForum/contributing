...
This loads your private SSH key and makes it availalbe to Git fro authentication to GitHub whenever you open a terminal. The last step is to add your public key to GitHub by copying the content of file `~/.ssh/id_rsa.pub` to https://github.com/settings/keys.
